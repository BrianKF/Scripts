...
echo
echo
cat $file |sed 's/.*"adm"//'|sed 's/"adomain".*//'|sed s'/^.//'|sed s'/^.//'|sed s'/^.//'|sed s'/.$//'| sed "s/\\\\\"/\"/g" > Results/$file.VAST
#cat $file |sed 's/.*"adm"//'|sed 's/"adomain".*//'|sed s'/.$//'|sed s'/^.//'|sed s'/^.//'|sed s'/.$//'|sed s'/.$//'| sed "s/\\\\\"/\"/g" > Results/$file.VAST
cat $file |sed 's/.*"adm"//'|sed 's/"adomain".*//'|sed s'/^.//'|sed s'/^.//'|sed s'/.$//'|sed s'/.$//'| sed "s/\\\\\"/\"/g"
...
cat $file |sed 's/^.*uatimps//' | sed 's/Impression.*//'|cut -d ] -f1|sed s'/.$//'|awk '{ print "https://uatimps" $0 }' > impressionURL
echo
echo
cat impressionURL
